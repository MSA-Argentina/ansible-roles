...
sed -i.original '/backports\|proposed/! s/^deb http:\/\/.*archive.ubuntu.com/deb [arch=amd64] http:\/\/192.168.1.70/g' /etc/apt/sources.list

# Renaming security.ubuntu.com
sed -i 's/^deb http:\/\/security.ubuntu.com/deb [arch=amd64] http:\/\/192.168.1.70/g' /etc/apt/sources.list
